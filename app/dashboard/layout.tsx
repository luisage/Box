...
// El layout del dashboard es client component para manejar el sidebar móvil.
// La protección de ruta se hace en middleware.ts.
// El nombre de usuario se pasa como prop desde un server wrapper si se necesita;
// por ahora usamos un valor por defecto que se puede extender.
      ...
      {sidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-40 flex">
          ...
          <aside className="relative w-64 bg-[#0d0d0d] border-r border-gray-800 flex flex-col z-50 animate-in slide-in-from-left duration-200">
            <SidebarNav userName="Admin" onCloseMobile={() => setSidebarOpen(false)} />
          </aside>
        </div>
      )}
